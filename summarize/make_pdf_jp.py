...
def create_summary_pdf(database_path, template_path, output_path='summary_japanese.pdf', language='japanese'):
    # データベース接続を開始
...
# 使用例
create_summary_pdf('summaries.db', 'template.pdf', 'summary_japanese_sample.pdf')
